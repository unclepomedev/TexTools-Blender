...
class op(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        area_pairs = utilities_uv.multi_object_loop(
            get_texel_density, self, context, edit_mode, getmode, need_results=True
        )
        ...
        if sum_area_uv != 0 and sum_area_vt != 0:
            bpy.context.scene.texToolsSettings.texel_density = (
                sum_area_uv / sum_area_vt
            ) * bpy.context.preferences.addons[__package__].preferences.texel_density_scale
