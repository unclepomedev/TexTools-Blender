...
class op(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        utilities_uv.multi_object_loop(
            set_texel_density, self, context, edit_mode, getmode, setmode, density, udim_tile, column, row
        )
    ...
    if getmode != "IMAGE" or (image and getmode == "IMAGE"):
        ...
        for group in group_faces:
            ...
            if density > 0 and sum_area_uv > 0 and sum_area_vt > 0:
                ...
                scale = (density / (sum_area_uv / sum_area_vt)) / bpy.context.preferences.addons[
                    __package__
                ].preferences.texel_density_scale
